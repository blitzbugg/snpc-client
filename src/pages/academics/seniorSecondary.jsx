...
import { GraduationCap, FlaskConical, Calculator, Laptop, BookOpen, Trophy, Sparkles, School, ArrowRight } from 'lucide-react';
  ...
  const academicStreams = [
    {
      ...
      description: "Physics, Chemistry, Biology/Mathematics for medical and engineering careers"
    },
    {
      icon: Calculator,
      title: "Commerce Stream",
      description: "Accountancy, Business Studies, Economics for business and finance careers"
    },
    {
      icon: BookOpen,
      title: "Humanities Stream",
      description: "History, Political Science, Sociology for civil services and social sciences"
    },
    {
      icon: Laptop,
      title: "Computer Science",
      description: "Programming, data structures, and modern technology curriculum"
    },
    {
      icon: Trophy,
      title: "Competitive Prep",
      description: "Special coaching for JEE, NEET, CUET and other entrance exams"
    },
    {
      icon: GraduationCap,
      title: "Career Guidance",
      description: "Professional counseling for university admissions and career planning"
    }
  ];
            ...
            <>
              <Reveal>
                <div className="inline-flex items-center px-5 py-2.5 bg-[#123C73]/5 rounded-full border border-[#123C73]/10 mb-6">
                  <GraduationCap className="w-4 h-4 text-[#F4C430] mr-2" />
              ...
              <Reveal delay={200}>
                <p className="text-lg md:text-xl text-[#667085] max-w-3xl mx-auto leading-relaxed font-light">
                  {data?.subtitle || 'Specialized streams preparing students for higher education and competitive careers'}
                </p>
              </Reveal>
              ...
              <div className="flex items-center justify-center gap-4 mt-8">
                ...
                <School className="w-5 h-5 text-[#F4C430]" />
                <div className="h-px w-12 bg-[#F4C430]/30"></div>
              </div>
            </>
          )}
                    ...
                    <div className="relative">
                      <div className="relative overflow-hidden rounded-3xl shadow-2xl shadow-[#123C73]/10 group">
                        <img
                          ...
                          alt={data.mainImage.alt || 'Senior Secondary Section'}
                          ...
                          <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-[#123C73]/10">
                            <div className="grid grid-cols-2 gap-6 text-center">
                              ...
                              <div>
                                ...
                                <p className="text-xs text-[#667085] font-semibold uppercase tracking-wider">Major Streams</p>
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="absolute -top-4 -right-4 w-20 h-20 bg-[#F4C430] rounded-2xl flex items-center justify-center shadow-xl rotate-12">
                        <FlaskConical className="w-10 h-10 text-[#123C73]" />
                      </div>
                    </div>
                  )
                )}
              ...
              <Reveal delay={800} from="right">
                <div className="bg-white rounded-3xl p-6 shadow-lg border border-[#123C73]/5 mt-8">
                  <h3 className="text-lg font-bold text-[#1B1F24] mb-4 flex items-center gap-2">
                    <FlaskConical className="w-5 h-5 text-[#F4C430]" />
                    Major Streams
                  </h3>
                  <div className="grid grid-cols-2 gap-3">
                    {academicStreams.slice(0, 4).map((feature, index) => {
            ...
            <div>
              ...
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-[#667085] max-w-2xl mx-auto">
                  Comprehensive programs designed for board exams and competitive entrance preparation
                </p>
              </div>
