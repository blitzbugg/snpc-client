...
import { GraduationCap, Atom, Laptop, BookOpen, Trophy, Users, Sparkles, School, Calculator } from 'lucide-react';
...
const SecondaryPage = () => {
  ...
  // Secondary education features
  const secondaryFeatures = [
    {
      icon: Atom,
      title: "Advanced Sciences",
      description: "Physics, Chemistry, and Biology with well-equipped labs"
    },
    {
      icon: Calculator,
      title: "Mathematics",
    ...
    },
    {
      ...
      description: "Programming, digital literacy, and modern technology skills"
    },
    {
      icon: BookOpen,
      title: "Languages",
      description: "English, Hindi, and regional language mastery"
    },
    {
      icon: Users,
    ...
    },
    {
      icon: Trophy,
      title: "Co-Curricular",
      description: "Sports, arts, and club activities for all-round development"
    }
  ];
            ...
            <>
              ...
              <Reveal delay={200}>
                <p className="text-lg md:text-xl text-[#667085] max-w-3xl mx-auto leading-relaxed font-light">
                  {data?.subtitle || 'Preparing students for board examinations and future academic pursuits'}
                </p>
              </Reveal>
                    ...
                    <div className="relative">
                      <div className="relative overflow-hidden rounded-3xl shadow-2xl shadow-[#123C73]/10 group">
                        <img
                          ...
                          alt={data.mainImage.alt || 'Secondary Section'}
                      ...
                      <div className="absolute -top-4 -right-4 w-20 h-20 bg-[#F4C430] rounded-2xl flex items-center justify-center shadow-xl rotate-12">
                        <Atom className="w-10 h-10 text-[#123C73]" />
                      </div>
                    </div>
                  )
                )}
              ...
              <Reveal delay={800} from="right">
                <div className="bg-white rounded-3xl p-6 shadow-lg border border-[#123C73]/5 mt-8">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {secondaryFeatures.slice(0, 4).map((feature, index) => {
