...
const PrePrimaryPage = () => {
  ...
  return (
    <div className="relative bg-gradient-to-br from-blue-50 via-white to-cyan-50 py-16 lg:py-24 overflow-hidden">
        ...
        {/* {!loading && !error && data?.useCases && (
          <div className="mb-20">
            <Reveal delay={900}>
              ...
              <p className="text-lg text-gray-600 text-center mb-12 max-w-2xl mx-auto">
                Building strong foundations across key areas of growth
              </p>
            </Reveal>
      ...
      {/* Decorative Elements */}
      <div className="absolute top-20 left-10 w-3 h-3 bg-pink-500 rounded-full animate-pulse"></div>
      <div
        className="absolute top-32 right-20 w-2 h-2 bg-yellow-400 rounded-full animate-pulse"
        style={{ animationDelay: "1s" }}
      ></div>
      <div
        className="absolute bottom-20 left-20 w-4 h-4 bg-purple-400 rounded-full animate-pulse"
        style={{ animationDelay: "2s" }}
      ></div>
      <div
        className="absolute bottom-40 right-32 w-3 h-3 bg-pink-500 rounded-full animate-pulse"
        style={{ animationDelay: "1.5s" }}
      ></div>
      <div
        className="absolute top-1/2 left-32 w-2 h-2 bg-yellow-400 rounded-full animate-pulse"
