...
import { Baby, Heart, Palette, Music, BookOpen, Sun, Sparkles, Smile } from 'lucide-react';
...
const PrePrimaryPage = () => {
  ...
  // Pre-primary features
  const prePrimaryFeatures = [
    {
      icon: Heart,
      title: "Nurturing Environment",
      description: "Safe and caring atmosphere for emotional and social development"
    },
    {
      icon: Palette,
      title: "Creative Arts",
      description: "Art, craft, and creative expression activities for young minds"
    },
    {
      icon: Music,
      title: "Music & Movement",
      description: "Rhythmic activities and musical exploration for motor skills"
    },
    {
      icon: BookOpen,
      title: "Story Time",
      description: "Interactive storytelling sessions to develop language skills"
    },
    {
      icon: Sun,
      title: "Outdoor Play",
      description: "Supervised outdoor activities for physical development"
    },
    {
      icon: Smile,
      title: "Social Skills",
      description: "Group activities fostering friendship and cooperation"
    }
  ];
            ...
            <>
              <Reveal>
                <div className="inline-flex items-center px-5 py-2.5 bg-[#123C73]/5 rounded-full border border-[#123C73]/10 mb-6">
                  <Baby className="w-4 h-4 text-[#F4C430] mr-2" />
              ...
              <Reveal delay={200}>
                <p className="text-lg md:text-xl text-[#667085] max-w-3xl mx-auto leading-relaxed font-light">
                  {data?.subtitle || 'Where little minds begin their journey of discovery and joyful learning'}
                </p>
              </Reveal>
              ...
              <div className="flex items-center justify-center gap-4 mt-8">
                ...
                <Smile className="w-5 h-5 text-[#F4C430]" />
                <div className="h-px w-12 bg-[#F4C430]/30"></div>
              </div>
            </>
          )}
                    ...
                    <div className="relative">
                      <div className="relative overflow-hidden rounded-3xl shadow-2xl shadow-[#123C73]/10 group">
                        <img
                          ...
                          alt={data.mainImage.alt || 'Pre-Primary Section'}
                      ...
                      <div className="absolute -top-4 -right-4 w-20 h-20 bg-[#F4C430] rounded-2xl flex items-center justify-center shadow-xl rotate-12">
                        <Baby className="w-10 h-10 text-[#123C73]" />
                      </div>
                    </div>
                  )
                )}
              ...
              <Reveal delay={800} from="right">
                <div className="bg-white rounded-3xl p-6 shadow-lg border border-[#123C73]/5 mt-8">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {prePrimaryFeatures.slice(0, 4).map((feature, index) => {
            ...
            <div>
              ...
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-[#667085] max-w-2xl mx-auto">
                  Holistic development through engaging activities and experiences
                </p>
              </div>

              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                {prePrimaryFeatures.map((feature, index) => {
                  const IconComponent = feature.icon;
                  return (
