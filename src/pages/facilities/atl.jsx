...
import { Lightbulb, Cpu, Wrench, Rocket, Award, Users, Sparkles, Zap } from 'lucide-react';
  ...
  const atlFeatures = [
    {
      ...
      description: "Sensors, microcontrollers, and Internet of Things development kits"
    },
    {
      icon: Wrench,
      title: "Tools & Equipment",
      description: "Professional-grade tools for prototyping and fabrication"
    },
    {
      icon: Rocket,
      title: "Robotics Kit",
      description: "Complete robotics platforms for building and programming"
    },
    {
      icon: Lightbulb,
      title: "Innovation Space",
      description: "Dedicated workspace for brainstorming and collaborative projects"
    }
  ];
            ...
            <>
              <Reveal>
                <div className="inline-flex items-center px-5 py-2.5 bg-[#123C73]/5 rounded-full border border-[#123C73]/10 mb-6">
                  <Lightbulb className="w-4 h-4 text-[#F4C430] mr-2" />
              ...
              <Reveal delay={200}>
                <p className="text-lg md:text-xl text-[#667085] max-w-3xl mx-auto leading-relaxed font-light">
                  {data?.subtitle || 'Fostering innovation and creativity through hands-on learning and experimentation'}
                </p>
              </Reveal>
                    ...
                    <div className="relative">
                      <div className="relative overflow-hidden rounded-3xl shadow-2xl shadow-[#123C73]/10 group">
                        ...
                        <div className="absolute bottom-6 left-6">
                          <div className="bg-white/95 backdrop-blur-sm rounded-2xl px-6 py-4 shadow-xl border border-[#123C73]/10">
                            <div className="flex items-center gap-3">
                              <div className="w-10 h-10 bg-[#F4C430] rounded-xl flex items-center justify-center">
                                <Award className="w-5 h-5 text-[#123C73]" />
                              </div>
                              <div>
                                <p className="font-bold text-[#1B1F24] text-sm">Powered by NITI Aayog</p>
                                <p className="text-xs text-[#667085]">Atal Innovation Mission</p>
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="absolute -top-4 -right-4 w-20 h-20 bg-[#F4C430] rounded-2xl flex items-center justify-center shadow-xl rotate-12">
                        <Rocket className="w-10 h-10 text-[#123C73]" />
                      </div>
                    </div>
                  )
                )}
              ...
              <Reveal delay={800} from="right">
                <div className="bg-white rounded-3xl p-6 shadow-lg border border-[#123C73]/5 mt-8">
                  <h3 className="text-lg font-bold text-[#1B1F24] mb-4 flex items-center gap-2">
                    <Lightbulb className="w-5 h-5 text-[#F4C430]" />
                    What is ATL?
                  </h3>
                  <p className="text-sm text-[#667085] leading-relaxed">
                    Atal Tinkering Labs (ATL) are innovative workspaces established under the 
                    Atal Innovation Mission by NITI Aayog to foster curiosity, creativity, and 
          ...
          <Reveal delay={600}>
            <div>
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
                {atlFeatures.map((feature, index) => {
                  const IconComponent = feature.icon;
                  return (
                    <Reveal key={index} delay={700 + index * 100}>
                      <div className="group relative bg-white rounded-3xl p-6 shadow-lg hover:shadow-2xl transition-all duration-500 border border-[#123C73]/5 hover:border-[#F4C430]/20 transform hover:-translate-y-2">
                        {/* Top Gradient Line */}
                        ...
                        <div className="relative inline-flex mb-4">
                          ...
                          <div className="relative w-16 h-16 bg-gradient-to-br from-[#F4C430]/10 to-[#123C73]/10 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                            <IconComponent className="w-8 h-8 text-[#123C73]" />
                          </div>
                        </div>
