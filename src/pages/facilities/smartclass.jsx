...
import { Monitor, BookOpen, Video, Wifi, Laptop, GraduationCap, Sparkles, Zap } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: "State-of-the-art digital whiteboards for immersive learning"
    },
    {
      icon: Wifi,
      title: "High-Speed Internet",
      description: "Seamless connectivity for uninterrupted digital education"
    },
    {
      icon: Video,
      title: "Video Conferencing",
      description: "Virtual classrooms connecting students globally"
    },
    {
      icon: BookOpen,
      title: "Digital Library",
      description: "Access to thousands of e-books and learning resources"
    },
    {
      icon: Laptop,
      title: "Learning Tablets",
      description: "Personal devices for interactive assignments"
    },
    {
      icon: GraduationCap,
      title: "Online Assessments",
      description: "Digital testing platforms for real-time evaluation"
    }
  ];
            ...
            <>
              <Reveal>
                <div className="inline-flex items-center px-5 py-2.5 bg-[#123C73]/5 rounded-full border border-[#123C73]/10 mb-6">
                  <Monitor className="w-4 h-4 text-[#F4C430] mr-2" />
              ...
              <Reveal delay={200}>
                <p className="text-lg md:text-xl text-[#667085] max-w-3xl mx-auto leading-relaxed font-light">
                  {data?.subtitle || 'Experience the future of education with our state-of-the-art digital learning environment'}
                </p>
              </Reveal>
                  ...
                  (data?.mainImage?.url || data?.image?.url) && (
                    <div className="relative">
                      ...
                      <div className="absolute -top-4 -right-4 w-20 h-20 bg-[#F4C430] rounded-2xl flex items-center justify-center shadow-xl rotate-12">
                        <Laptop className="w-10 h-10 text-[#123C73]" />
                      </div>
                    </div>
                  )
                )}
            ...
            <div>
              ...
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-[#667085] max-w-2xl mx-auto">
                  Our smart classrooms are equipped with cutting-edge technology for modern education
                </p>
              </div>
