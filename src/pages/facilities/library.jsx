...
import { BookOpen, Library, BookMarked, Users, Clock, Search, Globe, Sparkles } from 'lucide-react';
...
const LibraryPage = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await fetch(`${process.env.NEXT_PUBLIC_CMS_URL}/api/library`);
  ...
  const libraryFeatures = [
    {
      ...
      description: "Over 10,000 books covering academics, literature, and reference materials"
    },
    {
      icon: Search,
      title: "Digital Catalog",
      description: "Online search system for easy book location and availability"
    },
    {
      icon: Globe,
      title: "E-Resources",
      description: "Access to digital journals, e-books, and online databases"
    },
    {
      icon: Users,
      title: "Reading Areas",
      description: "Comfortable seating for individual and group study sessions"
    },
    {
      icon: Clock,
      title: "Extended Hours",
      description: "Open before and after school hours for student convenience"
    },
    {
      icon: BookOpen,
      title: "Reading Programs",
      description: "Regular reading challenges and literary events for students"
    }
  ];
            ...
            <>
              ...
              <Reveal delay={200}>
                <p className="text-lg md:text-xl text-[#667085] max-w-3xl mx-auto leading-relaxed font-light">
                  {data?.subtitle || 'A world of knowledge awaits our students in our well-stocked library'}
                </p>
              </Reveal>
              ...
              <div className="flex items-center justify-center gap-4 mt-8">
                ...
                <Library className="w-5 h-5 text-[#F4C430]" />
                <div className="h-px w-12 bg-[#F4C430]/30"></div>
              </div>
            </>
          )}
                    ...
                    <div className="relative">
                      <div className="relative overflow-hidden rounded-3xl shadow-2xl shadow-[#123C73]/10 group">
                        <img
                          ...
                          alt={data?.mainImage?.alt || data?.image?.alt || 'Library'}
                      ...
                      <div className="absolute -top-4 -right-4 w-20 h-20 bg-[#F4C430] rounded-2xl flex items-center justify-center shadow-xl rotate-12">
                        <Library className="w-10 h-10 text-[#123C73]" />
                      </div>
                    </div>
                  )
                )}
              ...
              <Reveal delay={800} from="right">
                <div className="bg-white rounded-3xl p-6 shadow-lg border border-[#123C73]/5 mt-8">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {libraryFeatures.slice(0, 4).map((feature, index) => {
            ...
            <div>
              ...
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-[#667085] max-w-2xl mx-auto">
                  Our library is equipped with modern facilities to support learning and research
                </p>
              </div>
