...
import { Presentation, Users, Monitor, Wifi, Coffee, Layout, Sparkles, Building } from 'lucide-react';
  ...
  const conferenceFeatures = [
    {
      icon: Monitor,
      title: "AV Equipment",
      description: "Advanced audio-visual systems for professional presentations"
    },
    {
      icon: Wifi,
      title: "High-Speed WiFi",
      description: "Reliable internet connectivity for all participants"
    },
    {
      icon: Users,
      title: "Flexible Seating",
      description: "Configurable seating arrangements for various events"
    },
    {
      icon: Coffee,
      title: "Refreshment Area",
      description: "Dedicated space for tea, coffee, and catering services"
    },
    {
      icon: Layout,
      title: "Modern Design",
      description: "Contemporary interior with professional ambiance"
    },
    {
      icon: Presentation,
      title: "Presentation Tools",
      description: "Projectors, screens, and whiteboards for effective meetings"
    }
  ];
            ...
            <>
              <Reveal>
                <div className="inline-flex items-center px-5 py-2.5 bg-[#123C73]/5 rounded-full border border-[#123C73]/10 mb-6">
                  <Building className="w-4 h-4 text-[#F4C430] mr-2" />
              ...
              <Reveal delay={200}>
                <p className="text-lg md:text-xl text-[#667085] max-w-3xl mx-auto leading-relaxed font-light">
                  {data?.subtitle || 'A professional venue for meetings, seminars, and corporate events'}
                </p>
              </Reveal>
              ...
              <div className="flex items-center justify-center gap-4 mt-8">
                ...
                <Presentation className="w-5 h-5 text-[#F4C430]" />
                <div className="h-px w-12 bg-[#F4C430]/30"></div>
              </div>
            </>
          )}
                  ...
                  (data?.mainImage?.url || data?.image?.url) && (
                    <div className="relative">
                          ...
                          <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-[#123C73]/10">
                            <div className="grid grid-cols-2 gap-6 text-center">
                              <div>
                                ...
                                <p className="text-xs text-[#667085] font-semibold uppercase tracking-wider">Capacity</p>
                              </div>
                              <div>
                                <div className="flex items-center justify-center gap-2 mb-2">
                                  <Layout className="w-5 h-5 text-[#123C73]" />
                                  <p className="text-2xl md:text-4xl font-extrabold text-[#123C73]">
                      ...
                      <div className="absolute -top-4 -right-4 w-20 h-20 bg-[#F4C430] rounded-2xl flex items-center justify-center shadow-xl rotate-12">
                        <Presentation className="w-10 h-10 text-[#123C73]" />
                      </div>
                    </div>
                  )
                )}
              ...
              <Reveal delay={800} from="right">
                <div className="bg-white rounded-3xl p-6 shadow-lg border border-[#123C73]/5 mt-8">
                  <h3 className="text-lg font-bold text-[#1B1F24] mb-4 flex items-center gap-2">
                    <Monitor className="w-5 h-5 text-[#F4C430]" />
                    Facilities
                  </h3>
                  <div className="grid grid-cols-2 gap-3">
                    {conferenceFeatures.slice(0, 4).map((feature, index) => {
            ...
            <div>
              ...
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-[#667085] max-w-2xl mx-auto">
                  Our conference hall is equipped with modern amenities for professional events
                </p>
              </div>
