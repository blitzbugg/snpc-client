...
import { Dumbbell, Table, Target, Gamepad2, Trophy, Timer, Sparkles, Activity } from 'lucide-react';
...
const SportsRoomPage = () => {
  ...
  // Indoor sports features
  const indoorSportsFeatures = [
    {
      icon: Table,
      title: "Table Tennis",
      description: "Professional table tennis setups for practice and competition"
    },
    {
      icon: Target,
      title: "Carrom Board",
      description: "Multiple carrom boards for recreational and competitive play"
    },
    {
      icon: Gamepad2,
      title: "Chess Room",
      description: "Dedicated chess area with tournament-standard boards"
    },
    {
      icon: Dumbbell,
      title: "Fitness Area",
      description: "Basic fitness equipment for strength and conditioning"
    },
    {
      icon: Trophy,
      title: "Competitions",
      description: "Regular indoor sports tournaments and championships"
    },
    {
      icon: Timer,
      title: "Practice Sessions",
      description: "Scheduled practice times for all indoor sports"
    }
  ];
  ...
  return (
    <div className="relative bg-gradient-to-br from-[#F7F9FC] via-white to-[#F7F9FC] py-16 lg:py-24 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <>
              <Reveal>
                <div className="inline-flex items-center px-5 py-2.5 bg-[#123C73]/5 rounded-full border border-[#123C73]/10 mb-6">
                  <Dumbbell className="w-4 h-4 text-[#F4C430] mr-2" />
              ...
              <Reveal delay={200}>
                <p className="text-lg md:text-xl text-[#667085] max-w-3xl mx-auto leading-relaxed font-light">
                  {data?.subtitle || 'Indoor sports facilities for year-round athletic development and recreation'}
                </p>
              </Reveal>
                    ...
                    <div className="relative">
                      <div className="relative overflow-hidden rounded-3xl shadow-2xl shadow-[#123C73]/10 group">
                        <img
                          ...
                          alt={data?.mainImage?.alt || data?.image?.alt || 'Sports Room'}
                          ...
                          <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-[#123C73]/10">
                            <div className="grid grid-cols-2 gap-6 text-center">
                              <div>
                                ...
                                <p className="text-xs text-[#667085] font-semibold uppercase tracking-wider">Sq. Ft.</p>
                              </div>
                              <div>
                                <div className="flex items-center justify-center gap-2 mb-2">
                                  <Gamepad2 className="w-5 h-5 text-[#123C73]" />
                                  <p className="text-2xl md:text-4xl font-extrabold text-[#123C73]">
                                    8+
                                  </p>
                                </div>
                                <p className="text-xs text-[#667085] font-semibold uppercase tracking-wider">Indoor Games</p>
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="absolute -top-4 -left-4 w-20 h-20 bg-[#F4C430] rounded-2xl flex items-center justify-center shadow-xl -rotate-12">
                        <Dumbbell className="w-10 h-10 text-[#123C73]" />
                      </div>
                    </div>
                  )
                )}
              ...
              <Reveal delay={800} from="right">
                <div className="bg-white rounded-3xl p-6 shadow-lg border border-[#123C73]/5 mt-8">
                  <h3 className="text-lg font-bold text-[#1B1F24] mb-4 flex items-center gap-2">
                    <Table className="w-5 h-5 text-[#F4C430]" />
                    Indoor Games
                  </h3>
                  <div className="grid grid-cols-2 gap-3">
                    {indoorSportsFeatures.slice(0, 4).map((feature, index) => {
        ...
        {/* Indoor Sports Features Section */}
        {!loading && !error && (
          <Reveal delay={600}>
            <div>
              {/* Section Divider */}
              ...
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-[#667085] max-w-2xl mx-auto">
                  Our sports room offers a variety of indoor games for all-weather activity
                </p>
              </div>

              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                {indoorSportsFeatures.map((feature, index) => {
                  const IconComponent = feature.icon;
                  return (
