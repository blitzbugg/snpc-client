...
import { Quote, MessageSquare, User, RefreshCw, Sparkles, Award } from 'lucide-react';
        ...
        <div className="relative mb-8">
          <div className="flex flex-col sm:flex-row items-start gap-6">
            ...
            <div className="flex-1 pt-2 sm:pt-8">
              <Skeleton height={28} width={200} className="mb-2" baseColor="#E8EDF5" highlightColor="#F7F9FC" />
              <Skeleton height={20} width={160} baseColor="#E8EDF5" highlightColor="#F7F9FC" />
            </div>
          </div>
        </div>
        <div className="space-y-3">
          <Skeleton height={16} width="100%" count={5} containerClassName="space-y-3" baseColor="#E8EDF5" highlightColor="#F7F9FC" />
        </div>
      </div>
    </div>
  );
        ...
        <div className="space-y-8 lg:space-y-12">
          {loading ? (
            ...
            leaders.map((leader, index) => (
              ...
              >
                <div className="bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden border border-[#123C73]/5 group">
                  {/* Top Gradient Bar */}
